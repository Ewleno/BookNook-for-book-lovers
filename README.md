...
3. **Create Book**: Add a new book to the library
4. **Edit Book**: Edit your own book (you should see Edit/Delete buttons)
5. **Authorization Test**: Try to edit/delete another user's book (should fail)
6. **Logout**: Sign out and verify you're redirected to login

## Team Collaboration

This project uses Git for version control. All team members should:
- Create feature branches for new work
- Commit regularly with descriptive messages
- Push to the shared GitHub repository
